...
async def main():
    ...
    await client.subscribe_quotes(["BSR",
    "CII",
    "CSV",
    "CTS",
    "DCM",
    ...
    "VIX",
    "VND",
    "ACB","BCM","BID","LPB","CTG","FPT","GAS","GVR","HDB","HPG",
    "MBB","MSN","MWG","PLX","VPL","SAB","SHB","SSB","SSI","STB",
    "TCB","TPB","VCB","VHM","VIB","VIC","VJC","VNM","VPB","VRE"

    ], on_quote=handle_quote, encoding=encoding, board_id="G1")
