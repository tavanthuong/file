...
def main():
    ...
    status, body = client.get_instruments(symbol="SSI,SHS,ACB,AAA,VGI,CTCB2604,NKG,VIX,HPG,", market_id="", security_group_id="", index_name="", limit=100, page=1, dry_run=False)
    print(status, body)
